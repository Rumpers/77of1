...
export default function OnboardStep3() {
  ...
  const t = getMessages(locale).onboard.step3;
  ...
  async function handleConfirm() {
    ...
    try {
      ...
      console.error("[onboard-step3] submit failed", err);
    ...
    return (
      <main style={pageStyle}>
        <div style={cardStyle}>
          ...
          <p style={bodyStyle}>
            {personaGranted ? t.success.body_with_persona : t.success.body_no_persona}
          </p>
        </div>
      </main>
    );
        ...
        <div style={cardStyle}>
          ...
          >
            {GRANT_TYPES.map((gt) => {
              ...
              const item = t.items[gt];
              return (
                <div key={gt} style={summaryRowStyle}>
                  <span style={{ fontSize: "1.2rem" }}>{item.emoji}</span>
                  <span
                    style={{ flex: 1, fontSize: "0.95rem", fontWeight: 500 }}
                  >
                    {item.label}
                  </span>
                  <span
                    style={{
                      fontSize: "0.85rem",
                      fontWeight: 600,
                      color: granted ? GRANTED_COLOR : OPTIONAL_COLOR,
                    }}
                  >
              ...
              <div key={gt} style={itemCardStyle}>
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    {isOpen && (
                      <p style={legalTextStyle}>{item.legal}</p>
                    )}
                  </div>
                </div>
